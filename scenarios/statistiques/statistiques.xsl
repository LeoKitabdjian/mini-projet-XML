            ...
            <body>
                <main>
                    <section>
                        <h1>Statistiques</h1>
                        <article>
                            <h2>Répartition du type de clients</h2>
                            <ul>
                                <li>
                                ...
                                <li>
                                    ...
                                    <span>
                                        <xsl:value-of
                                                select="count(organisme/clients/client[@typePublic='enfant_adolescent'])"/>
                                    </span>
                                </li>
                            </ul>
                        </article>
                        <article>
                            <h2>Répartition des langues des professeurs</h2>
                            <ul>
                                <li>
                                    <span>Anglais</span>
                                    <span>
                                        <xsl:value-of
                                                select="count(organisme/enseignants/enseignant[langue = 'anglais'])"/>
                                    </span>
                                </li>
                                <li>
                                    <span>Français</span>
                                    <span>
                                        <xsl:value-of
                                                select="count(organisme/enseignants/enseignant[langue = 'francais'])"/>
                                    </span>
                                </li>
                                <li>
                                    <span>Italien</span>
                                    <span>
                                        <xsl:value-of
                                                select="count(organisme/enseignants/enseignant[langue = 'italien'])"/>
                                    </span>
                                </li>
                                <li>
                                    <span>Espagnol</span>
                                    <span>
                                        <xsl:value-of
                                                select="count(organisme/enseignants/enseignant[langue = 'espagnol'])"/>
                                    </span>
                                </li>
                                <li>
                                    <span>Allemand</span>
                                    <span>
                                        <xsl:value-of
                                                select="count(organisme/enseignants/enseignant[langue = 'allemand'])"/>
                                    </span>
                                </li>
                            </ul>
                        </article>
                        <article>
                            <h2>Répartition des langues de séjours</h2>
                            <ul>
                                <li>
                                    <span>Anglais</span>
                                    <span>
                        ...
                        <article>
                            <h2>Répartition des cibles de séjours</h2>
                            <ul>
                                <li>
                                ...
                                <li>
                                    ...
                                    <span>
                                        <xsl:value-of
                                                select="count(organisme/sejours/sejour[typePublic = 'enfant_adolescent'])"/>
                                    </span>
                                </li>
                            </ul>
                        </article>
                        <article>
                            <h2>Répartition des types de séjours</h2>
                            <ul>
                                <li>
                                    <span>Immersions en famille</span>
                                    <span>
                                        <xsl:value-of
                                                select="count(organisme/sejours/sejour[@typeSejour = 'immersion_en_famille'])"/>
                                    </span>
                                </li>
                                <li>
                                    ...
                                    <span>
                                        <xsl:value-of
                                                select="count(organisme/sejours/sejour[@typeSejour = 'stage_linguistique'])"/>
                                    </span>
                                </li>
                                <li>
                                    ...
                                    <span>
                                        <xsl:value-of
                                                select="count(organisme/sejours/sejour[@typeSejour = 'colonie_de_vacances'])"/>
                                    </span>
                                </li>
                            </ul>
                        </article>
